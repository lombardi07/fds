  ...
  SUBROUTINE DUMP_EVAC_CSV(Tin)
    ...
    IF (n_dead>=0 .OR. lim_n_dead>=0) THEN ! losa: incapacitation limits
       ...
       IF (ii_density > ii_ntargets) THEN
          WRITE(tcform,'(a,i4.4,a,a,i4.4,a,a,a)') "(ES13.5E3,", n_cols, "(',',i8)", "," , & ! losa: text item "a" added for new line
       ...
       ELSE
          WRITE(tcform,'(a,i4.4,a,a,a)') "(ES13.5E3,",n_cols+1, & ! losa: text item "a" added for new line
