...
LIM_INC_CO   = 3000._EB ! losa: define default for CO concentration (ppm)
LIM_INC_CO2  = 10000._EB ! losa: define default for CO2 concentration (ppm)
LIM_INC_O2   = 15._EB ! losa: define default for O2 volume fraction (%)
LIM_INC_HCN  = 30._EB ! losa: define default for HCN concentration (ppm)
LIM_INC_VIS  = 5._EB ! losa: define default for visibility (m)
...
NAMELIST /COMB/ CHECK_REALIZABILITY,COMPUTE_ZETA_SOURCE_TERM,EXTINCTION_MODEL,FIXED_MIX_TIME,HRRPUV_MAX_SMV,&
                INITIAL_UNMIXED_FRACTION,MAX_CHEMISTRY_SUBSTEPS,N_FIXED_CHEMISTRY_SUBSTEPS,ODE_SOLVER,RADIATIVE_FRACTION,&
...
REAL(EB) :: SOOT_YIELD,CO_YIELD,EPUMO2,A, &
            ...
            TURBULENT_FLAME_SPEED_ALPHA,TURBULENT_FLAME_SPEED_EXPONENT
...
NAMELIST /REAC/ A,AUTO_IGNITION_TEMPERATURE,C,CHECK_ATOM_BALANCE,CO_YIELD,CRITICAL_FLAME_TEMPERATURE,&
                E,EPUMO2,K,EQUATION,FLAME_SPEED,FLAME_SPEED_EXPONENT,FLAME_SPEED_TEMPERATURE,FORMULA,FUEL,&
                FUEL_RADCAL_ID,FWD_ID,FYI,H,HEAT_OF_COMBUSTION,&
                ID,IDEAL,N,NU,N_S,N_T,O,RADIATIVE_FRACTION,RAMP_CHI_R,RAMP_FS,REAC_ATOM_ERROR,&
                REAC_MASS_ERROR,REVERSE,SOOT_H_FRACTION,SOOT_YIELD,&
                SPEC_ID_N_S,SPEC_ID_NU,TABLE_FS,&
                THIRD_BODY,TURBULENT_FLAME_SPEED_ALPHA,TURBULENT_FLAME_SPEED_EXPONENT
...
USE SCRC, ONLY: SCARC_METHOD, SCARC_KRYLOV, SCARC_MULTIGRID, SCARC_SMOOTH, SCARC_PRECON, &
                SCARC_DISCRETIZATION, SCARC_COARSE, SCARC_INITIAL, SCARC_ACCURACY, SCARC_DEBUG , &
