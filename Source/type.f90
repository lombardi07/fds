...
INTEGER, PARAMETER :: N_PARTICLE_SCALAR_REALS=17,N_PARTICLE_SCALAR_INTEGERS=9,N_PARTICLE_SCALAR_LOGICALS=2
...
INTEGER, PARAMETER :: N_CFACE_SCALAR_REALS=8,N_CFACE_SCALAR_INTEGERS=5,N_CFACE_SCALAR_LOGICALS=0

TYPE CFACE_TYPE
   TYPE (ONE_D_M_AND_E_XFER_TYPE) :: ONE_D
   REAL(EB), POINTER :: AREA,X,Y,Z,NVEC(:),VEL_ERR_NEW
...
TYPE HUMAN_TYPE
   ...
   REAL(EB) :: LimTmp=0._EB,IncRad=0._EB,LimCO=0._EB,LimCO2=0._EB,LimO2=0._EB,LimHCN=0._EB,LimVis=0._EB ! losa: incapacitating quantity
   ...
   REAL(EB) :: Lim_FallenDown=0._EB ! losa: incapacitation time
